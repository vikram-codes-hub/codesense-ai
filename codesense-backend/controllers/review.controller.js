...
const manualReview = async (req, res, next) => {
  try {
    ...
    if (!code || !language)
      return error(res, 400, "Please provide code and language");

    // Get or create manual repo for this user
...
module.exports = { getReviews, getReview, getReviewFiles, manualReview, deleteReview };